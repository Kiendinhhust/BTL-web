...
Shop.hasMany(ShopRevenueSummary, {
  foreignKey: "shop_id",
  as: "revenueSummaries",
  onDelete: "CASCADE",
});
...
Product.hasMany(ProductRevenueSummary, {
  foreignKey: "product_id",
  as: "revenueSummaries",
  onDelete: "CASCADE",
});
...
ProductRevenueSummary.belongsTo(Product, {
  foreignKey: "product_id",
  as: "product",
}); // FK đã là CASCADE
