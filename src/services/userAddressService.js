...
export const updateUserAddress = (userId, addressId, addressData) => {
  return axios.put(`${API_URL}/api/address/${userId}/addresses/${addressId}`, addressData);
};

export const deleteUserAddress = (userId, addressId) => {
  return axios.delete(`${API_URL}/api/address/${userId}/addresses/${addressId}`);
};

export const setDefaultAddress = (userId, addressId) => {
  return axios.put(`${API_URL}/api/address/${userId}/addresses/${addressId}/default`);
};
